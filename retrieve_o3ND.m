...
function [N_O3_SG,ratio_P]=retrieve_o3ND(pon,poff,start_bin,frame_len1,frame_len2,frame_len3,h1,h2,sm_len)
...
for i=1:len_t
  ...
  diff0(start_bin:h1-1)=diff1(start_bin:h1-1); diff0(h1)=(diff1(h1)+diff2(h1))/2;
