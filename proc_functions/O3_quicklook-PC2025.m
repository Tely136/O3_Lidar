function output = O3_quicklook(data,times,configs,params)
    ...
    dsigma_o3_temp = load('auxiliary_data\dsigma_287d1_299d2_temperature_lookup.mat');
    ...
    D_qo3 = dsigma_m./dsigma_o3_2d.*10^9;
...
function [output] = preprocess(an,pc,hkm,times,configs,params)
    ...
    % Remove background
    [an_bg_rem,an_bg,an_b_coeff] = remove_background(an_avg,hkm,bg_bins,configs,"linear");
    [pc_dt_bg_rem,pc_bg,pc_b_coeff] = remove_background(pc_dt,hkm,bg_bins,configs,"linear");  
