function [NC,pathname]=newgetbschm15k_nearrange(instruction,startingfolder)
...
NC.Height=Height(16:18);%from 225m to 255m
for i=1:nfiles 
...
% Time average and height move average
    T=20;% Time average number, 15*T/60 min average
