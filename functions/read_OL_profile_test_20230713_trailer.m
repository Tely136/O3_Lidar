...
%%
function [OLfileName,save_path]=read_OL_profile_test(folder_path,save_path,nbin,dzm,bgbins,td,nAvg,sib_hkm)
% 
%
...
%     end 
    profile_287_an_raw(:,k)= Data.data(:,3);
    profile_299_an_raw(:,k)= Data.data(:,5);
    % profile_287_nr_an_raw(:,k)= Data.data(:,5);
    % profile_299_nr_an_raw(:,k)= Data.data(:,7);
% PC signal
    profile_287_pc_raw(:,k)= Data.data(:,4);
    profile_299_pc_raw(:,k)= Data.data(:,6);
