function [new_sigprof,hkm_fr,hkm_nr] = gate_prof(sigprof,start_bin_fr,start_bin_nr,hkm)
    ...
    new_sigprof.an287fr = sigprof.an287fr(start_bin_fr:end,:);
    new_sigprof.pc287fr = sigprof.pc287fr(start_bin_fr:end,:);
    new_sigprof.an299fr = sigprof.an299fr(start_bin_fr:end,:);
    new_sigprof.pc299fr = sigprof.pc299fr(start_bin_fr:end,:);
